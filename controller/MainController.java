...
public class MainController implements Initializable {
  ...
  public void iniciar(){
    ...
    for(int i=0; i<N ;i++){//definindo os semaforos, instanciando os filosofos e as velocidades iniciais.
      forks [i] = new Semaphore(0);
      filosofos[i] = new Filosofo(i, this);
      states[i] = 0;
      velocidadeEscutando[i].setValue(5);
      velocidadeTocando[i].setValue(5);
    }
    for (int j=0; j<N; j++){//definindo os vizinhos de cada filosofo
